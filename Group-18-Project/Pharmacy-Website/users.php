<?php
        ...
        if($conn->connect_error){
            ...
            if(isset($_REQUEST['user'])){
               if($_REQUEST['Username']!=""&&$_REQUEST['Fullname']!=""&&$_REQUEST['Email']!=""&&$_REQUEST['Phoneno']!=""&&$_REQUEST['Pass']!=""){
                    $input = $_REQUEST['Username'];    
                    $input1 = $_REQUEST['Fullname'];
                    $input2 = $_REQUEST['Email'];
                    $input3 = $_REQUEST['Phoneno'];
                    $input4 = $_REQUEST['Pass'];  
                    echo '<script>alert("Data taken successfull")</script>';
                    echo '<script>windows: location="user.php"</script>';
                    $sql = "INSERT INTO user(Username,Fullname,Email,Phoneno,Pass) VALUES('$input','$input1','$input2','$input3','$input4')";
